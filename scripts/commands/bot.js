...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "কেউ সিয়াম বসের হবু বউকে দেখছো নি সিয়াম বস খুজে পাচ্ছেনা তার বউকে🐸🐷🐼",
          " ༆༊🦋 পৃথিবীতে সবাই প্রেম করে কিন্তু সবাই আমার বস সিয়াম ভায়কে সন্দেহ করে😑🐷🫂",
          " ─༆🌺●───༆༊🦋●───༆🌺●───༆༊🦋আরে বলদা বার বার ডাকিস কেন সিয়াম বসের সাথে বিজি আমি অনেক─༅༎༅༎༅─ 😑😑😑",
          "─༆🌺●───༆༊🦋ফেসবুকে একটা বিন নাই এজন্য সিয়াম বস ফেসবুকে নাগিনদের ধরতে পারছে না 🐸🐷🐍",
          "〲আমাকে না ডেকে এসকে সিয়াম বসরে একটা জিএফ দে সিয়াম বস আজও সিঙ্গেল বস একটাও প্রেম করতে পারলেন না আজও●══❥𝄞⋆⃝🐸🐼🐷"
          "─༆🌺●───༆༊🦋আমাকে ডেকে ভুল করলি আবাল এখন তোর বউ আমার শুধুই আমার কিন্তু আমার বস এসকে সিয়াম ভাইয়ের সাথে একটু সেয়ার করবো তোর বউকে🫂🐸😑",
          "༆🌺●───༆༊🦋আমাকে এতো না ডেকে বস সিয়ামকে একটা গফ দে ●───༆🌺●───༆༊🦋🙄",
          "🌺●───༆༊🦋সিয়াম বসের নেতৃত্বে আমি আজও সিঙ্গেল 😑🐸●───༆🌺●───༆༊🦋সাথে বালপাকনা বস সিয়াম আজও একটা মেয়েকে পটাতে পারলো না ●───༆🌺●───༆༊🦋😏🐼🐷 ",
          "༆🌺●─── ডাকিস না আমার বস এসকে সিয়াম বসের মন ভালো নাই সিরিয়াস একটা গফ লাগবে বলদা ─༅༎༅😑🫂🐸"
        ];
